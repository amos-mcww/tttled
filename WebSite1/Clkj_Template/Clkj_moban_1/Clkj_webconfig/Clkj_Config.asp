...
sub gallery_leftnav()
		...
		if big_cc=big_id or small_dd=big_id then'实现伸缩
			  response.write "<li class="&chr(34)&"sem-mid-left-1-1-1"&chr(34)&" id="&chr(34)&"imgmenu"&big_id&""&chr(34)&" style="&chr(34)&"cursor:hand"&chr(34)&" onClick="&chr(34)&"showsubmenu("&big_id&")"&chr(34)&"><a href="&chr(34)&"Gallery.asp?big="&big_id&""&chr(34)&">"&rs("clkj_BigClassName")&"</a></li><span id="&chr(34)&"submenu"&big_id&""&chr(34)&" >"
		Else
				response.write "<li class="&chr(34)&"sem-mid-left-1-1-1"&chr(34)&" id="&chr(34)&"imgmenu"&big_id&""&chr(34)&" style="&chr(34)&"cursor:hand"&chr(34)&" onClick="&chr(34)&"showsubmenu("&big_id&")"&chr(34)&"><a href="&chr(34)&"Gallery.asp?big="&big_id&""&chr(34)&">"&rs("clkj_BigClassName")&"</a></li><span id="&chr(34)&"submenu"&big_id&""&chr(34)&" style="&chr(34)&"display:none"&chr(34)&">"
		End if
			set rs_1=server.createobject("adodb.recordset")
			...
			response.write"<li class='sem-mid-left-1-1-2' id='lefts2'><a href="&chr(34)&"Gallery.asp?small="&small_id&""&chr(34)&">"&rs_1("clkj_SmallClassName")&"</a></li>"
...
Function gallery_ileibie()
    set rs3=server.createobject("adodb.recordset")
    if request("big") then
        exec="select * from clkj_gallery_BigClass where clkj_BigClassID="&request("big")
        rs3.open exec,conn,1,1
        response.write "<a href=Gallery.asp?big="&request("big")&">"&rs3("clkj_BigClassName")&"</a>"
    elseif request("small") then
        exec="select  * from clkj_gallery_SmallClass  where clkj_SmallClassID="&request("small")
        rs3.open exec,conn,1,1
        response.write "<a href=Gallery.asp?small="&request("small")&">"&rs3("clkj_SmallClassName")&"</a>"
    else
        response.write "<a href=Gallery.asp>New Gallerys</a>"
    end if
End Function

Function gallery_ileibie2(da)

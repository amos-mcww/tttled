  ...
  <div class="all">
    ...
    <div class="T_mid">
      ...
      <div class="T_mid_R">
        <div class="T_mid_R_1">
          <ul>
            <li class="T_mid_R_1_li"><strong class="T_mid_R_1_strong"><%=clkj_news_Titlef%></strong></li>
            <li> The group has been devoted to independent R&D and innovation since 1997, when it was first engaged in the R&D of high-tech products and developed the first NBL-1010 Electronic Linear Accelerator in China. The plus material of PTFE Millipore membrane developed in 1999 was recognized as "National Key New Product" and won the "National Science & Technology Progress Award (first class)".<br>


The company has won many honorable titles, such as "The Top Medium-sized Township Enterprise Nationwide", "Provincial Spark Model Enterprise", "Key and Pillar Enterprise of Zhejiang Province", "Top 1000 National Township Enterprises Earning Foreign Exchange through Export", and "Contract-Complying and Trustworthy Company with AA-level Credit of Zhejiang Province". YUNHUAN power plug cord has been recognized as "Name Brand Product of Zhejiang Province", and "Yunhuan" as a national well-known trademark. "Yunhuan" has also been appraised as "Famous Brand of Zhejiang Province".<br>

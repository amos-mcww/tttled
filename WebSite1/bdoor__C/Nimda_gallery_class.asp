...
<table width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td height="39" class="tr_bg">&nbsp;<strong>Gallery栏目管理</strong> <font color="#0033ff"><%=request.querystring("Lei")%></font></td>
  </tr>
</table>
...
<tr>
<td width="25%" height="30" align="center" valign="middle"><p>静态文件链接名称</p>
  <p>(可不填)</p></td>
<td width="75%" align="left" class="h_td"><p>&nbsp;
  </p>
  <p>
...
%>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<form name="big_class" action="Nimda_function.asp?Class=gallery_big" method="post">
<tr>
...
<tr>
<td width="25%" height="30" align="center" valign="middle">序号</td>
<td width="75%" align="left" class="h_td"><input name="big_paixu" type="text" id="big_paixu" value="1" size="5">
  多个gallery项目中,数字越大该类越靠前</td>
</tr>
<tr>
<td width="25%" height="30" align="center" valign="middle">&nbsp;</td>
